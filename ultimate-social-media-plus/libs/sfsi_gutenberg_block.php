...
function sfsi_plus_render_gutenberg_rectangle($args = null, $content = null,$share_url=null){
    ...
    if($sfsi_plus_place_item_gutenberg == "yes")
    {
        ...
        if( $sfsi_section4['sfsi_plus_display_counts'] == "yes" ) {
            $show_count=1;
            $sfsiLikeWith="75px;";
        } else {
            $show_count=0;
        ...
        if( $sfsi_section8['sfsi_plus_rectsub'] == 'yes' || $sfsi_section8['sfsi_plus_rectfb'] == 'yes' || $sfsi_section8['sfsi_plus_recttwtr'] == 'yes' || $sfsi_section8['sfsi_plus_rectpinit'] == 'yes' || $sfsi_section8['sfsi_plus_rectfbshare'] == 'yes' ) {
            ...
            $icons = "<div class='sfsi_plus_Sicons " . $float . $mouse_hover_effect."' style='" . $style . "'>";
                if( $txt ) {
                    $icons .= "<div style='display: inline-block;margin-bottom: 0; margin-left: 0; margin-right: 8px; margin-top: 0; vertical-align: middle;width: auto;'><span>".$txt."</span></div>";
                }
