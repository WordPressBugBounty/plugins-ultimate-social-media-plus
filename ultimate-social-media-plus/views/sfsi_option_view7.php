...
<div class="tab7">
	...
	if ( $sfsi_plus_banner_popups == "yes" ) {
        ...
        <div id="sfsi_firsttime_offer" class="sfsi_new_prmium_follw  sfsi_banner_body">
            <div>
                <p>Update: if you want many more features for your pop-ups, have a look at <a target="_blank"
                                                                                              href="https://sellcodes.com/s/3NmlIE"
                                                                                              style="color:#1a1d20 !important;font-weight: bold;border-bottom: 1px solid #1a1d20;">MyPopUps.</a>
                </p>
            </div>
    ...
    <div class="like_pop_box">
        <div class="sfsi_plus_Popinner">
            ...
            <ul class="like_icon plus_sfsi_sample_icons">
                ...
                <li class="sfsiplus_threads_section">
                    <div>
                        <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/threads.png" alt="Threads"/>
                        <span class="sfsi_Cdisplay" id="sfsi_plus_threads_countsDisplay">12k</span>
                    </div>
                </li>
                ...
                <li class="sfsiplus_bluesky_section">
                    <div>
                        <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/bluesky.png" alt="Bluesky"/>
                        <span class="sfsi_Cdisplay" id="sfsi_plus_bluesky_countsDisplay">12k</span>
                    </div>
                </li>
                ...
                <li class="sfsi_mastodon_section">
                    <div>
                        <img src="<?php echo SFSI_PLUS_PLUGURL ?>images/icons_theme/default/default_mastodon.png"
                             alt="Mastodon"/>
    ...
    <div class="space">
        ...
        <div class="text_options">
            ...
            <div class="sfsiplus_row_tab">
                ...
                <input class="mkPop" name="sfsi_plus_popup_text" type="text"
                       value="<?php echo ( $option7['sfsi_plus_popup_text'] != '' ) ? __( $option7['sfsi_plus_popup_text'], 'ultimate-social-media-plus' ) : ''; ?>"/>
            </div>
            <div class="sfsiplus_row_tab">
            ...
            <div class="sfsiplus_row_tab">
                ...
                <input name="sfsi_plus_popup_fontColor" data-default-color="#b5b5b5" id="sfsi_plus_popup_fontColor"
                       type="text"
                       value="<?php echo ( $option7['sfsi_plus_popup_fontColor'] != '' ) ? $option7['sfsi_plus_popup_fontColor'] : ''; ?>"/>
            </div>
            <div class="sfsiplus_row_tab">
                <label>
					<?php _e( 'Font size:', 'ultimate-social-media-plus' ); ?>
                </label>
                <input name="sfsi_plus_popup_fontSize" type="text"
                       value="<?php echo ( $option7['sfsi_plus_popup_fontSize'] != '' ) ? $option7['sfsi_plus_popup_fontSize'] : ''; ?>"
                       class="small"/>
            </div>
        </div>
        <div class="text_options layout">
            ...
            <div class="sfsiplus_row_tab">
                ...
                <input name="sfsi_plus_popup_background_color" data-default-color="#b5b5b5"
                       id="sfsi_plus_popup_background_color" type="text"
                       value="<?php echo ( $option7['sfsi_plus_popup_background_color'] != '' ) ? $option7['sfsi_plus_popup_background_color'] : ''; ?>"/>
            </div>
            <div class="sfsiplus_row_tab">
                <label class="border">
                ...
                <div class="field">
                    <input name="sfsi_plus_popup_border_color" data-default-color="#b5b5b5"
                           id="sfsi_plus_popup_border_color" type="text"
                           value="<?php echo ( $option7['sfsi_plus_popup_border_color'] != '' ) ? $option7['sfsi_plus_popup_border_color'] : ''; ?>"/>
                </div>
            </div>
            <div class="sfsiplus_row_tab">
                <label>
                ...
                <div class="field">
                    <input name="sfsi_plus_popup_border_thickness" type="text"
                           value="<?php echo ( $option7['sfsi_plus_popup_border_thickness'] != '' ) ? $option7['sfsi_plus_popup_border_thickness'] : ''; ?>"
                           class="small"/>
                </div>
            </div>
            <div class="sfsiplus_row_tab">
                ...
                <ul class="border_shadow">
                    <li>
                        <input name="sfsi_plus_popup_border_shadow" <?php echo ( $option7['sfsi_plus_popup_border_shadow'] == 'yes' ) ? 'checked="true"' : ''; ?>
                    ...
                    <li>
                        <input name="sfsi_plus_popup_border_shadow" <?php echo ( $option7['sfsi_plus_popup_border_shadow'] == 'no' ) ? 'checked="true"' : ''; ?>
    ...
    <div class="row">
        ...
        <div class="pop_up_show">
            <input name="sfsi_plus_Show_popupOn" <?php echo ( $option7['sfsi_plus_Show_popupOn'] == 'none' ) ? 'checked="true"' : ''; ?>
                   type="radio" value="none" class="styled"/>
            <label>
				<?php _e( 'Nowhere', 'ultimate-social-media-plus' ); ?>
            </label>
        </div>
        <div class="pop_up_show">
            <input name="sfsi_plus_Show_popupOn" <?php echo ( $option7['sfsi_plus_Show_popupOn'] == 'everypage' ) ? 'checked="true"' : ''; ?>
        ...
        <div class="pop_up_show">
            <input name="sfsi_plus_Show_popupOn" <?php echo ( $option7['sfsi_plus_Show_popupOn'] == 'blogpage' ) ? 'checked="true"' : ''; ?>
                   type="radio" value="blogpage" class="styled"/>
            <label>
				<?php _e( 'On blog posts only', 'ultimate-social-media-plus' ); ?>
            </label>
        </div>
        <div class="pop_up_show">
            <input name="sfsi_plus_Show_popupOn" <?php echo ( $option7['sfsi_plus_Show_popupOn'] == 'selectedpage' ) ? 'checked="true"' : ''; ?>
                   type="radio" value="selectedpage" class="styled"/>
            <label>
				<?php _e( 'On selected pages only', 'ultimate-social-media-plus' ); ?>
            </label>
            <div class="field" style="width:50%">
                <select multiple="multiple" name="sfsi_plus_Show_popupOn_PageIDs" id="sfsi_plus_Show_popupOn_PageIDs"
    ...
    <div class="row">
        ...
        <div class="pop_up_show">
            <input name="sfsi_plus_Shown_pop" <?php echo ( $option7['sfsi_plus_Shown_pop'] == 'once' ) ? 'checked="true"' : ''; ?>
                   type="radio" value="once" class="styled"/>
            <label>
				<?php _e( 'Once', 'ultimate-social-media-plus' ); ?>
                <input name="sfsi_plus_Shown_popupOnceTime" type="text"
        ...
        <div class="pop_up_show">
            <input name="sfsi_plus_Shown_pop" <?php echo ( $option7['sfsi_plus_Shown_pop'] == 'ETscroll' ) ? 'checked="true"' : ''; ?>
                   type="radio" value="ETscroll" class="styled"/>
            <label>
		...
		<?php if ( $option7['sfsi_plus_premium_popup_box'] == 'yes' ) { ?>
            ...
            <div class="sfsi_plus_new_prmium_follw">
                ...
                <p>
					...
					<?php _e( 'The Premium Plugin also allows you to show the pop-up when  the user tries to leave your page. Also, you can limit how often the pop-up is shown to the same user (e.g. only once per day) ', 'ultimate-social-media-plus' ); ?>
                    <br>-
                    &nbsp;&nbsp;<?php _e( 'Show it when the users try to leave your page', 'ultimate-social-media-plus' ); ?>
                    <br>-
                    &nbsp;&nbsp;<?php _e( 'Limit how often the pop-up is shown to the same user (e.g. only once per day)', 'ultimate-social-media-plus' ); ?>
                    <br>-
                    &nbsp;&nbsp;<?php _e( 'Select to show the subscription form in the pop-up (which you designed in question 8)', 'ultimate-social-media-plus' ); ?>
                    <br>
                    <a style="cursor:pointer" class="pop-up" data-id="sfsi_plus_quickpay-overlay"
                       onclick="sfsi_plus_open_quick_checkout(event)" class="sfisi_plus_font_bold"
                       target="_blank"><?php _e( 'Go premium now', 'ultimate-social-media-plus' ); ?></a><a
                            href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmplus_settings_page&utm_campaign=more_popup_options&utm_medium=banner"
                            class="sfsi_plus_font_inherit"
                            target="_blank"><?php _e( ' or learn more', 'ultimate-social-media-plus' ); ?></a>
                </p>
            </div>
